	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/rneoru-missedkey/misskey-v12" target="_blank">Misskey v12(Forked)</a></small>
			</div>
		</div>
	</div>
